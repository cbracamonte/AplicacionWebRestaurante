...
public class Pedido {
    ...
    public static final String ESTADO_SIN_COBRAR = "SIN COBRAR";
    ...
    public List<LineaDePedido> getLineasDePedido() {
     ...
     //Reglas de Nogocio
    public boolean agregarLineaDePedido(int cantidad, String condicion, Producto producto){ //lineadepedido: cantidad, condicion, producto
